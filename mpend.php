...
$claimno="";
  include 'conn.php';
    ...
    if (isset($_POST['submit'])){
      ...
      $q1="delete from medclaim where claimno='$claimno';";
      mysqli_query($con,$q);
      mysqli_query($con,$q1);
...
$q="select * from medclaim where claimno='$claimno';";
...
$row = mysqli_fetch_array($result);
  ...
  echo "<th style='background-color: #3399ff;
  color: white;'>Date of Accident</th>";
  echo "<td style='background-color: #ccc;'>" . $row['accdate'] . "</td>";
  echo "</tr>";
  ...
  echo "<th style='background-color: #3399ff;
  color: white;'>Hospital Name</th>";
  echo "<td style='background-color: #ccc;'>" . $row['hosp'] . "</td>";
  echo "<th style='background-color: #3399ff;
  color: white;'>Medical Expenses</th>";
  echo "<td style='background-color: #ccc;'>" . $row['medex'] . "</td>";
  echo "</tr>";
  ...
  echo "<th style='background-color: #3399ff;
  color: white;'>Prior Medical History</th>";
  echo "<td style='background-color: #ccc;'>" . $row['prior'] . "</td>";
  echo "<th style='background-color: #3399ff;
  color: white;'>Physician's Name</th>";
  echo "<td style='background-color: #ccc;'>" . $row['phy'] . "</td>";
  echo "</tr>";
  ...
  echo "<th style='background-color: #3399ff;
  color: white;'>List</th>";
  echo "<td style='background-color: #ccc;'>" . $row['list'] . "</td>";
  echo "</tr>";
